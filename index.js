...
for(var i =0;i<lengthOfDrums;i++) {
	document.querySelectorAll("button")[i].addEventListener("click",buttonClilcked);
}

function buttonClilcked() {
	var getValueOfLetter = this.innerHTML;
	makeSound(getValueOfLetter);
	anim(getValueOfLetter);
}
